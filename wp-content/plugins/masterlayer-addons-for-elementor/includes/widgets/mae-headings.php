	...
	protected function register_controls() {
		...
		// Content 
			...
			$this->add_control(
	            'headingTag',
	            [
	                'label'     => __( 'Heading Tag', 'masterlayer'),
	                'type'      => Controls_Manager::SELECT,
	                'default'   => 'default',
	                'options'   => [
	                    'default'          => __( 'Default', 'masterlayer'),
	                    'h1'          => __( 'H1', 'masterlayer'),
	                    'h2'          => __( 'H2', 'masterlayer'),
	                    'h3'          => __( 'H3', 'masterlayer'),
	                    'h4'          => __( 'H4', 'masterlayer'),
	                    'h5'          => __( 'H5', 'masterlayer'),
	                    'h6'          => __( 'H6', 'masterlayer'),
	                    'span'          => __( 'Span', 'masterlayer'),
	                    'div'          => __( 'Div', 'masterlayer'),
	                ],
	                'condition' => ['heading!' => '']
	            ]
	        );
		...
		// Color
			...
			$this->add_control(
				...
				[
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .master-heading .line' => 'background-color: {{VALUE}};',
					],
	...
	protected function render() {
		...
		<div class="master-heading sep-<?php echo esc_attr($settings['sep']); ?>">
	        ...
	        <?php if ( ! empty( $settings['heading'] ) ) { 
	            $tag = 'h2';
	            if ($settings['headingTag'] !== 'default') {
	                $tag = $settings['headingTag'];
	            }
	        ?>
	            <<?php echo $tag; ?> class="main-heading"><?php echo $settings['heading']; ?></<?php echo $tag; ?>>
	        <?php } ?>
