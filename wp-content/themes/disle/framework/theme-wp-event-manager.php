...
add_action( 'init', 'disle_add_event_excerpt' );
function disle_add_event_excerpt() {
     add_post_type_support( 'event_listing', 'excerpt' ); 
}

// Archive template
add_filter( 'archive_template', 'disle_event_archive', 20 );
function disle_event_archive($template) {
