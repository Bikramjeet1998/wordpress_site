    ...
    protected function register_controls() {
        // Content
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors'  => [
                        '{{WRAPPER}} .disle-hamburger-icon' => 'line-height: {{SIZE}}{{UNIT}}',
                    ],
                    50,
                ]
            );
        ...
        // Content - Hidden Menu
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [ '.elementor-preview {{WRAPPER}} .disle-menu-panel .menu-panel-wrap' => 'right: {{VALUE}};' ]
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors'  => [
                        '{{WRAPPER}} .disle-menu-panel .menu-logo' => 'max-width: {{SIZE}}{{UNIT}}',
                    ],
                    50,
                    'condition' => [ 'panel_type' => 'default' ]
                ]
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors'  => [
                        ...
                        '{{WRAPPER}} .master-social-icons a svg' => 'width: {{SIZE}}{{UNIT}}',
                    ],
                    50,
                    'condition' => [ 'social_icons' => 'yes' ]
                ]
        ...
        // Style - Color
            ...
            $this->add_control(
                'panel_bgcolor',
                [
                    'label' => __( 'Panel Background', 'masterlayer' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .disle-menu-panel .menu-panel-wrap' => 'background-color: {{VALUE}}',
                    ]
                ]
            );
            ...
            $this->add_control(
                'menu_color',
                [
                    'label' => __( 'Menu Text Color', 'masterlayer' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .disle-menu-panel ul li a' => 'color: {{VALUE}}',
                    ]
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .disle-menu-panel .desc' => 'color: {{VALUE}}',
                    ]
                ]
            );
                ...
                //Tab - normal
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .disle-hamburger-icon' => 'color: {{VALUE}}',
                            ]
                        ]
                    );
                ...
                //Tab - hover
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .disle-hamburger-icon:hover' => 'color: {{VALUE}}',
                            ]
                        ]
                    );
                            ...
                            if ( $settings['menu_panel_logo_image'] ) { ?>
                                <div class="menu-logo">
                                    <a aria-label="logo" href="<?php echo esc_url(get_home_url()); ?>">
                                        <?php echo wp_get_attachment_image( $settings['menu_panel_logo_image']['id'], 'full', false, ['loading' => true] ); ?>
                                    </a>
                                </div>
                            <?php } ?>
