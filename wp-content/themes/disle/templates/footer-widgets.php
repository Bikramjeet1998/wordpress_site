...
if ( ! disle_get_mod( 'footer_widgets', true ) )
	return false;

// Get defaults from Customizer
$columns = disle_get_mod( 'footer_columns', '4' );
$gutter = disle_get_mod( 'footer_column_gutter', '30' );
...
<footer id="footer" style="<?php echo disle_footer_bg(); ?>">	
	<div id="footer-widgets" class="disle-container">
